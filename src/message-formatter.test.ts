...
describe('it', () => {
  ...
  1. "[Top Cat](http://some-server/web/index.html#!/itemdetails.html?id=id1)" - Series
  2. "[Cat Videos Vol. 1](http://some-server/web/index.html#!/itemdetails.html?id=id2)" - Movie
  3. "[Cat Videos Vol. 3](http://some-server/web/index.html#!/itemdetails.html?id=id3)" - Movie`
    );
  });
});
